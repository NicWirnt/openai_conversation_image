...
type AirPollutionDataProps = {
  data: AirQualityData;
};

const AirPollution = ({ data }: AirPollutionDataProps) => {
  if (!data) {
  ...
  return (
    <div className="air-pollution w-full h-full rounded-lg p-0">
      <Card className=" col-span-2 flex flex-col justify-between h-full">
        <CardContent className="my-auto p-2 h-full">
          <div className="flex flex-col gap-2">
            <div className="flex flex-row gap-2 justify-start">
              ...
              <p className=" font-bold text-sm">Air Pollution</p>
            </div>
            <div>
              <Progress
