...
const AdditionalMultiplierTableCell = ({
  tableId,
  rowData,
  columnData,
  columnListData,
  ...
  const updateAdditionalMultiplierCell = editorStore(
    useShallow((state) => state.updateAdditionalMultiplierCell),
  );
    ...
    <div className="flex flex-col gap-1">
      <CurrencyInput
        ...
        onBlur={() => {
          ...
          updateAdditionalMultiplierCell({
...
export const AdditionalMultiplierTableCellMemoized = memo(
  AdditionalMultiplierTableCell,
  isCellEqual,
);
