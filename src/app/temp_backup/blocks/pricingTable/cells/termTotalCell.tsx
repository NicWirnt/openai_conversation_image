...
type CellProps = {
  rowData: ProductRow;
  tableId: string;
  columnData: TermTotalPricingTableColumn;
  columnListData:
    | PricingTableColumn[]
    | TaxPricingTableColumn[]
    | TotalPricingTableColumn[];
...
export const TermTotalTableCellMemoized = memo(TermTotalTableCell, isCellEqual);
