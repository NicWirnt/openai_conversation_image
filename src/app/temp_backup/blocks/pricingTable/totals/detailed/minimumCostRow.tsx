...
import { capitalizeString } from "@/utils/genericHelpers";
...
const MinimumCostRow = ({
  pricingData,
  hasRecuringMultiplier,
  focused,
}: {
  pricingData: PricingTableData;
  hasRecuringMultiplier: RecuringMultiplierPricingTableColumn;
  focused: boolean;
}) => {
  ...
  return (
    <tr>
      ...
      >
        Minimum {capitalizeString(hasRecuringMultiplier?.periodLabel)} Cost
      </td>
