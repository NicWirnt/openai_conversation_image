...
import { getEndDate, getStartDate } from "../index";
...
const Explorer = ({
  ...
  const fieldMap = {
    flight: {
      segmentStart: {
        start: [
          { path: "flight.departs.airport.airportName", type: "text" },
          {
            path: "flight.departs.airport.airportLocation.cityName",
            type: "text",
          },
        ],
        on: { path: "flight.marketingCarrier.name", type: "text" },
        in: undefined,
        from: undefined,
      },
      segmentEnd: {
        end: [
          { path: "flight.arrives.airport.airportName", type: "text" },
          {
    ...
    hotel: {
      segmentStart: {
        start: [
          { path: "hotel.supplier.supplier.supplierCode.name", type: "text" },
        ],
        on: undefined,
        in: { path: "hotel.city.cityName", type: "text" },
        from: undefined,
      },
      segmentEnd: {
        end: [],
    ...
    car: {
      segmentStart: {
        ...
        on: undefined,
        in: undefined,
        from: { path: "car.supplier.supplier.supplierCode.name", type: "text" },
      },
      segmentEnd: {
        end: [
          {
    ...
    train: {
      segmentStart: {
        start: [
          { path: "rail.pickupLocation", type: "text" },
          { path: "rail.departs.address.line1", type: "text" },
          {
      ...
      segmentEnd: {
          ...
          { path: "rail.dropoffLocation", type: "text" },
          { path: "rail.arrives.address.line1", type: "text" },
          {
    ...
    bus: {
      segmentStart: {
        start: [
          { path: "bus.pickupLocation", type: "text" },
          {
      ...
      segmentEnd: {
          ...
          { path: "bus.dropoffLocation", type: "text" },
          {
    ...
    cruise: {
      segmentStart: {
        start: [
          { path: "cruise.departs.name", type: "text" },
          {
            path: "cruise.departs.locationCityDateTime.city.cityName",
            type: "text",
          },
        ],
        on: { path: "cruise.cruiseDetails.shipName", type: "text" },
        in: undefined,
        from: undefined,
      },
      segmentEnd: {
        end: [
          { path: "cruise.arrives.name", type: "text" },
          {
    ...
    ferry: {
      segmentStart: {
        start: [
          { path: "ferry.departs.name", type: "text" },
          { path: "ferry.departs.address.line1", type: "text" },
          {
      ...
      segmentEnd: {
          ...
          { path: "ferry.arrives.name", type: "text" },
          { path: "ferry.arrives.address.line1", type: "text" },
          {
    ...
    activity: {
      segmentStart: {
        start: [{ path: "activity.departs.city.cityName", type: "text" }],
        on: undefined,
        in: undefined,
        from: undefined,
      },
      segmentEnd: {
        end: [{ path: "activity.arrives.city.cityName", type: "text" }],
      },
      fields: [
        [
          {
    ...
    package: {
      segmentStart: {
        start: [{ path: "packageCi.departs.city.cityName", type: "text" }],
        on: undefined,
        in: undefined,
        from: undefined,
      },
      segmentEnd: {
        end: [{ path: "packageCi.arrives.city.cityName", type: "text" }],
      },
      fields: [
        [
          {
    ...
    tour: {
      segmentStart: {
        start: [
          { path: "tour.departs.address.line1", type: "text" },
          {
      ...
      segmentEnd: {
          ...
          { path: "tour.arrives.address.line1", type: "text" },
          {
    ...
    transfer: {
      segmentStart: {
        start: [
          { path: "transfer.pickUp", type: "text" },
          { path: "transfer.departs.address.line1", type: "text" },
          {
      ...
      segmentEnd: {
          ...
          { path: "transfer.dropOff", type: "text" },
          { path: "transfer.arrives.address.line1", type: "text" },
          {
    ...
    ownArrangement: {
      segmentStart: {
        start: [{ path: "ownArrangement.from.city.cityName", type: "text" }],
        on: undefined,
        in: undefined,
        from: undefined,
      },
      segmentEnd: {
        end: [{ path: "ownArrangement.to.city.cityName", type: "text" }],
      },
      fields: [
        [
          {
    ...
    surface: {
      segmentStart: {
        start: [{ path: "surface.departs.city.cityName", type: "text" }],
        on: undefined,
        in: undefined,
        from: undefined,
      },
      segmentEnd: {
        end: [{ path: "surface.arrives.city.cityName", type: "text" }],
      },
      fields: [
        [
          {
            ...
            inputs: [
              {
                ...
                path: "surface.supplier.supplier.supplierCode.name",
                type: "text",
              },
            ],
            colSpan: 3,
    ...
    insurance: {
      segmentStart: {
        start: [{ path: "insurance.bookingDate", type: "datetime" }],
        on: undefined,
        in: undefined,
        from: undefined,
      },
    ...
    miscellaneous: {
      segmentStart: {
        start: [{ path: "miscellaneous.departs.city.cityName", type: "text" }],
        on: undefined,
        in: undefined,
        from: undefined,
      },
      segmentEnd: {
        end: [{ path: "miscellaneous.arrives.city.cityName", type: "text" }],
      },
      fields: [
        [
          {
    ...
    >
      {type !== "bookingDetails" && (
        <div className="segment ">
          <div className="segment-heading flex items-center gap-1 border-b border-[#999] pb-2">
            <div className="icon">
              <SegmentIcon type={type as SegmentType} className="fa-xl" />
            </div>
            <div className="segment-heading-text uppercase">
              <h1>{dict.itinerary[type].heading2}</h1>
            </div>
          ...
          <div className="segment-detail">
            ...
            <table className="segment-table black flightTimeTable">
              <tbody>
                <tr>
                  <td className="table-heading flightTimeHeading">
                    {(
                      getStartDate(segmentData, type) ?? new Date()
                    )?.toLocaleTimeString([], {
                      hour: "2-digit",
                  ...
                  <td className="flightTimeValue w-auto whitespace-normal">
                    {dict.itinerary[type].start}:{" "}
                    <b>
                      {fieldMap[type].segmentStart?.start.map(
                        (field: any, fi: number) => {
                          return getSegmentData(segmentData, field)
                            ? `${
                                field.type === "datetime"
                                  ? getSegmentData(
                                      segmentData,
                                  ...
                                  : getSegmentData(segmentData, field)
                              }${
                                fieldMap[type].segmentStart?.start.length -
                                  1 !==
                                fi
                                  ? ", "
                                  : " "
                    ...
                    {fieldMap[type].segmentStart?.from &&
                      getSegmentData(
                        segmentData,
                        fieldMap[type].segmentStart?.from,
                      ) && (
                    ...
                    {type === "flight" &&
                    getSegmentData(segmentData, { path: "flight.flightNumber" })
                      ? " flight"
                      : ""}{" "}
                    <b>
            ...
            <table className="segment-table black mb-[20px]">
              <tbody>
                {fieldMap[type]?.fields.map((row: any[], index: number) => {
                  return (
                    <React.Fragment key={index}>
                      {row.map((field, key) => {
                        ...
                        return (
                          <tr key={key}>
                            <td className="table-heading normalHeading vertical-align-top w-[35%] !pl-[105px]">
                              {field.label}
                            </td>
                            <td className="table-value segment-value">
                              <div
            ...
            <table className="segment-table black flightTimeTable">
              <tbody>
                <tr>
                  <td className="table-heading flightTimeHeading">
                    {(
                      getEndDate(segmentData, type) ?? new Date()
                    )?.toLocaleTimeString([], {
                      hour: "2-digit",
                      minute: "2-digit",
                      hour12: true,
                  ...
                  <td className="flightTimeValue w-auto whitespace-normal">
                    {dict.itinerary[type].end}:{" "}
                    <b>
                      {fieldMap[type].segmentEnd?.end.map(
                        (field: any, fi: number) => {
                          return getSegmentData(segmentData, field)
                            ? `${
                                field.type === "datetime"
            ...
            {type === "flight" && (
              <table className="segment-table black mb-[20px] ml-[105px] w-[652px]">
                <tbody>
                  <tr>
                    <td className="table-heading normalHeading w-[28%]">
                      {dict.itinerary.flight.end}{" "}
                      {dict.itinerary.flight.terminal}:
                    </td>
                    <td>
                      {getSegmentData(segmentData, {
                        path: "flight.arrives.terminal",
      ...
      {!edit && (
        <div className="segment ">
          <div className="segment-heading flex items-center gap-1 border-b border-[#999] pb-2">
            ...
            <div className="segment-heading-text">
          ...
          <div className="segment-detail">
            <h2>Tuesday, 20 June 2023</h2>
            <table className="segment-table black flightTimeTable">
              <tbody>
                <tr>
                  <td className="table-heading flightTimeHeading">09:10 AM</td>
                  <td className="flightTimeValue w-auto whitespace-normal">
                    Depart: <b>Kingsford Smith, Sydney (SYD), Australia</b>, on{" "}
                    <b>
                      <span
                        className="editable"
                        data-path="flight.marketingCarrier.name"
                        data-field="Marketing Carrier"
                      >
                        American Airlines
                      </span>
                    </b>{" "}
                    ...
                    <b>
                      <span
                        ...
                        data-field="Marketing Carrier Code"
                      >
                        AA
                      </span>{" "}
                      <span
            ...
            <table className="segment-table black mb-[20px] ml-[105px] w-[652px]">
              <tbody>
                <tr>
                  ...
                  <td
                    className="table-value editable"
                    data-path="flight.departs.terminal"
                    data-field="Departure Terminal w-full"
                  >
                    Terminal 1
                  </td>
                </tr>
                <tr>
                  ...
                  <td
                    className="table-value editable"
                    data-path="flight.classOfService.name"
                    data-field="Class w-full"
                  >
                    Economy
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td className="table-value w-full">13 hours 50 minutes</td>
                </tr>
                <tr>
                  <td className="table-heading normalHeading w-[28%]">
                    Number of Stops:
                  </td>
                  <td className="table-value w-full">Non-stop</td>
                </tr>
              </tbody>
            </table>
            <table className="segment-table black flightTimeTable">
              <tbody>
                <tr>
                  <td className="table-heading flightTimeHeading">06:00 AM</td>
                  <td className="flightTimeValue w-auto whitespace-normal">
                    Arrive: <b>International, Los Angeles (CA) (LAX), USA</b>,
                    on <b>Tuesday, 20 June 2023</b>
                  </td>
                </tr>
              </tbody>
            </table>
            <table className="segment-table black mb-[20px] ml-[105px] w-[652px]">
              <tbody>
                <tr>
                  ...
                  <td
                    className="table-value editable"
                    data-path="flight.arrives.terminal"
                    data-field="Arrival Terminal w-full"
                  >
                    Terminal B
                  </td>
                </tr>
