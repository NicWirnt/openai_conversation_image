...
import { getStartDate } from "../index";
...
const Escape = ({
  ...
  const fieldMap = {
    flight: {
      segmentTitle: [
        { path: "flight.marketingCarrier.name", type: "text" },
        { path: "flight.flightNumber", type: "text" },
      ],
      fields: [
        [
          {
    ...
    hotel: {
      segmentTitle: [
        { path: "hotel.supplier.supplier.supplierCode.name", type: "string" },
      ],
      fields: [
        [
          {
    ...
    car: {
      segmentTitle: [
        { path: "car.supplier.supplier.supplierCode.name", type: "string" },
      ],
      fields: [
        [
          {
    ...
    train: {
      segmentTitle: [
        { path: "rail.supplier.supplier.supplierCode.name", type: "string" },
      ],
      fields: [
        [
          {
    ...
    bus: {
      segmentTitle: [
        { path: "bus.supplier.supplier.supplierCode.name", type: "string" },
      ],
      fields: [
        [
          {
    ...
    cruise: {
      segmentTitle: [{ path: "cruise.cruiseDetails.shipName", type: "string" }],
      fields: [
        [
          {
    ...
    ferry: {
      segmentTitle: [
        { path: "ferry.supplier.supplier.supplierCode.name", type: "string" },
      ],
      fields: [
        [
          {
    ...
    activity: {
      segmentTitle: [
        { path: "activity.supplier.supplierCode.name", type: "string" },
      ],
      fields: [
        [
          {
    ...
    package: {
      segmentTitle: [{ path: "packageCi.packageName", type: "string" }],
      fields: [
        [
          {
    ...
    tour: {
      segmentTitle: [
        { path: "tour.supplier.supplier.supplierCode.name", type: "string" },
      ],
      fields: [
        [
          {
    ...
    surface: {
      segmentTitle: [
        { path: "surface.supplier.supplier.supplierCode.name", type: "string" },
      ],
      fields: [
        [
          {
    ...
    insurance: {
      segmentTitle: [
        { path: "insurance.supplier.supplierCode.name", type: "string" },
      ],
      fields: [
        [
          {
    ...
    miscellaneous: {
      segmentTitle: [
        { path: "miscellaneous.supplier.supplierCode.name", type: "string" },
      ],
      fields: [
        [
          {
      ...
      {type !== "bookingDetails" && (
        <div className="segment ">
          <div className="segment-detail">
            <h2 className="date-head rounded-md border-2 border-solid px-[10px] py-[2px]">
              {(
            ...
            <div className="date-head relative mt-[36px] rounded-md border-2 border-solid p-[10px]">
              <i className="fa normal fa-plane absolute left-[-30px] top-[-27px] text-[46px]"></i>{" "}
              <SegmentIcon
                type={type}
                className="absolute left-[-30px] top-[-27px] bg-white px-[15px] pb-[15px] pt-[4px] text-[46px]"
              ></SegmentIcon>
              <span className="absolute left-[-25px] top-[25px] text-[8px]">
                {dict.itinerary[type].heading2}
              </span>
              <div className="flex flex-row-reverse items-center">
                <div className="segment-date-top-right text-16 float-right ml-5 rounded-md bg-blue-800 px-[7px] text-center font-bold uppercase text-white">
                  {(
                    getStartDate(segmentData, type) ?? new Date()
                  )?.toLocaleDateString([], {
                    day: "2-digit",
                ...
                <div className="float-right text-[28px] uppercase">
                  {fieldMap[type]?.segmentTitle?.map(
                    (field: any, index: number) => {
                      return (
                        <React.Fragment key={index}>
                          <span>{getSegmentData(segmentData, field)}</span>
                          {getSegmentData(segmentData, field) &&
                            index !==
                              fieldMap[type]?.segmentTitle?.length - 1 &&
                            getSegmentData(
                              segmentData,
                              fieldMap[type]?.segmentTitle[index + 1],
                            ) && <span> - </span>}
                        </React.Fragment>
                      );
                    },
              ...
              <table className="segment-table black mb-0">
                <tbody>
                    ...
                    return (
                      <React.Fragment key={index}>
                        {row.map((field, key) => {
                          ...
                          return (
                            <tr key={key}>
                              <td className="table-heading normalHeading w-36 !pt-1">
                                {field.label}
                              </td>
                              <td className="table-value segment-value w-64 !pt-1">
                                <div
      ...
      {!edit && (
        <div className="segment ">
          <div className="segment-detail">
            ...
            <div className="date-head mt-[36px] rounded-md border-2 border-solid p-[10px]">
              <i className="fa normal fa-plane top-neg-27 left-neg-30 text-46 absolute"></i>{" "}
              <span className="top-33 left-neg-29 text-8 absolute">
                FLIGHT DETAILS
              </span>
              <div>
                <div className="segment-date-top-right text-16 float-right ml-5 rounded-md bg-blue-800 px-[7px] text-center font-bold uppercase text-white">
                ...
                <div className="text-28px float-right uppercase">
              ...
              <table className="segment-table black mb-0">
                <tbody>
                  <tr>
                    <td className="table-heading normalHeading w-36">From:</td>
                    <td className="table-value w-64">
                      Kingsford Smith, Sydney (SYD), Australia <br />
                      09:10 AM, Tuesday 20 June
                    </td>
                  </tr>
                  <tr>
                    <td className="table-heading normalHeading w-36">To:</td>
                    <td className="table-value w-64">
                      International, Los Angeles (CA) (LAX), USA <br />
                      06:00 AM, Tuesday 20 June
                    </td>
                  </tr>
                  <tr>
                    <td className="table-heading normalHeading w-36">
                      Departure:
                    </td>
                    <td className="table-value w-64">
                  ...
                  <tr>
                    ...
                    <td className="table-value editable w-64">Economy</td>
                  </tr>
                  <tr>
                    <td className="table-heading normalHeading w-36">
                      Aircraft:
                    </td>
                    <td className="table-value editable w-64">789</td>
                  </tr>
                  <tr>
                    <td className="table-heading normalHeading w-36">
                      Flying Time:
                    </td>
                    <td className="table-value w-64">13 hours 50 minutes</td>
                  </tr>
                  <tr>
                    <td className="table-heading normalHeading w-36">
                      Number of Stops:
                    </td>
                    <td className="table-value w-64">Non-stop</td>
                  </tr>
                </tbody>
              </table>
            </div>
